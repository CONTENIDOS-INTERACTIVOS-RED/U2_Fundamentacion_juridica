...
export default {
  ...
  data: () => ({
    cuestionario: {
      tema: 'Jerarquía Normativa en Colombia',
      ...
      preguntas: [
        {
          id: 1,
          texto:
            'La Constitución Política de Colombia es la base sobre la cual se estructura todo el ordenamiento jurídico en el país.',
        ...
        },
        {
          id: 2,
          texto:
            'Los decretos reglamentarios tienen el mismo nivel jerárquico que los decretos con fuerza de ley.',
          barajarRespuestas: true,
          opciones: [
        ...
        },
        {
          id: 3,
          texto:
            'La acción de inconstitucionalidad puede ser presentada por cualquier ciudadano.',
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
            { id: 'b', texto: 'Falso', esCorrecta: false },
        ...
        },
        {
          id: 4,
          texto:
            'Las resoluciones emitidas por ministros tienen una jerarquía superior a las leyes ordinarias.',
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
            { id: 'b', texto: 'Falso', esCorrecta: true },
        ...
        },
        {
          id: 5,
          texto:
            'La Constitución colombiana clasifica los derechos en individuales, sociales y colectivos.',
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
            { id: 'b', texto: 'Falso', esCorrecta: false },
